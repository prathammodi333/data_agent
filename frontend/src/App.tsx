  ...
  return <div className="app-shell">
    ...
    <main className="main">
      ...
      <div className="content">
        <div className="page-intro"><div className="eyebrow">YOUR DATA, IN PLAIN ENGLISH <span>✦</span></div><h1>Ask the data.<br /><em>See the work.</em></h1><p>Explore demo data with a routed SQL analyst and a flat-file ETL agent. Every answer shows what happened behind the scenes.</p></div>
